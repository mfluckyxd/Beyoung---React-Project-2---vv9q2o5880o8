...
const SingleOrder = () => {
    ...
    const {  totalPrice, status, orderDate,items, shipmentDetails } = orderData || {};
  ...
  return (
    <div className='order-details-container'>
        <Stack spacing={2}>
            <section className="order-details-head">Order <h6 style={{display:'inline-block'}}>#{id}</h6></section>
            <Divider/>
            ...
            <section className="order-details-payment">
                ...
                <p><PaymentIcon/> <span> Debit/Credit Card</span></p>
            </section>
            <Divider/>
        </Stack>
    </div>
